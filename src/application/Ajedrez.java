...
public class Ajedrez extends Application {
	...
	public void start(Stage principal) {
		try {
			...
			//Creo los botones y los a�ado a su Pane para crear el menu
			...
			Text creditos = new Text("Creado por Daniel Marchena Jim�nez");
			...
			System.err.println("Ha ocurrido un error, por favor reinicia la aplicaci�n");
		}
	}
	...
	public static void crearTablero() {
		...
		//A�ado las piezas negras al tablero
		...
		//A�ado las piezas blancas al tablero
